package com.abitech.abuzaraslam.sentiancetest.location_provider.location.providers;
...
import com.abitech.abuzaraslam.sentiancetest.location_provider.location.LocationStore;
import com.abitech.abuzaraslam.sentiancetest.location_provider.location.config.LocationAccuracy;
...
public class LocationManagerProvider implements LocationProvider, LocationListener {
    ...
    public void onProviderEnabled(String provider) {
        logger.d("onProviderEnable", provider);
    }

    @Override
    public void onProviderDisabled(String provider) {
        logger.d("onProviderDisable", provider);
    }
}
