package com.abitech.abuzaraslam.sentiancetest.location_provider.location.config;
...
public class LocationParams {
    // Defaults
    public static final LocationParams BEST_EFFORT = new Builder().setAccuracy(LocationAccuracy.MEDIUM).setDistance(0).setInterval(50).build();
